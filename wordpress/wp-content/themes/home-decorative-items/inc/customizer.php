...
function home_decorative_items_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( new Home_Decoration_Shop_Upsell_Section( $wp_customize, 'upsell_premium_section', array(
		'title'       => __( 'Home Decoration Shop', 'home-decorative-items' ),
	...
	$wp_customize->add_section( new Home_Decoration_Shop_Upsell_Section( $wp_customize, 'upsell_bundle_section', array(
...
if ( class_exists( 'WP_Customize_Section' ) ) {
	class Home_Decoration_Shop_Upsell_Section extends WP_Customize_Section {
