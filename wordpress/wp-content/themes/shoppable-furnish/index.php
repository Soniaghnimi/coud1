...
?>
	...
	<div id="content" class="site-content">
		<div class="container">
			...
			<!--Blog Feedbacks-->
			<?php get_template_part( 'template-parts/feedbacks/feedbacks' ); ?>

			<!--Blog Special Occasion-->
			<?php get_template_part( 'template-parts/special-occasion/special-occasion' ); ?>
							...
							<?php
								if( get_theme_mod( 'enable_pagination', true ) ):
									the_posts_pagination( array(
										...
										'next_text' => '<span>'.esc_html__( 'Next', 'shoppable-furnish' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'shoppable-furnish' ) . '</span>',
										'prev_text' => '<span>'.esc_html__( 'Prev', 'shoppable-furnish' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'shoppable-furnish' ) . '</span>',
										'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'shoppable-furnish' ) . ' </span>',
									));
								endif;
								wp_reset_postdata();
							?>
